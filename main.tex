...
\titlegraphic{%
    \includegraphics[width=1.5cm,height=1.5cm,keepaspectratio]{logos/CNRSfr}%
    \qquad\quad%
    \includegraphics[width=1.65cm,height=1.65cm,keepaspectratio]{logos/ecole_ponts_RVB300.jpg}%
    \qquad\quad%
    \raisebox{.2cm}{\includegraphics[width=1.75cm,height=1.75cm,keepaspectratio]{logos/LogoEsieeParis}}%
    \qquad\quad%
    \raisebox{.2cm}{\includegraphics[width=1.95cm,height=1.95cm,keepaspectratio]{logos/UPEM_LOGO_EDITION}}%
}%
